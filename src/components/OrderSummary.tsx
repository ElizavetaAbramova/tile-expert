...
export const OrderSummary = () => {
  return (
    <div className="order-summary w-full flex flex-col items-end">
      <div className="title bg-parchment-200 flex w-full rounded-t-sm">
        <div className="font-heading text-lg md:text-3xl uppercase bg-parchment-200 border-l-2 border-t-2 border-r-2 px-2 rounded-t-sm mb-1 mr-[-1px]">
          Order Summary
        </div>
